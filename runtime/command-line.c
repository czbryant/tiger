...
static void Arg_outputLog()
{
  Control_isOutLog = 1;
  Control_logInfo = (char*)malloc(sizeof(char)*Control_bufSize);
  memset(Control_logInfo,0,Control_bufSize);
}
static void Arg_printAllocInfo()
{
  Control_printNewInfo=1;
}
