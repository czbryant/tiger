...
public class PrettyPrintVisitor implements Visitor {
		...
		try {
			this.writer = new java.io.BufferedWriter(
					new java.io.OutputStreamWriter(
							new java.io.FileOutputStream("bin/"+c.id + ".j")));
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(1);
		}
	...
	public void visit(Arraylength s) {
		// TODO Auto-arraylengthgenerated method stub
...
//		this.say("Z");
	...
	public void visit(Getfield s) {
		...
		if(s.type.equals("@int[]")){
			type ="[I";
			this.isayln("getfield "+s.classid+"/"+s.id +" "+type);
		}
	...
	public void visit(Putfield s) {
		...
		if(s.type.equals("@int[]")){
			type ="[I";
			this.isayln("putfield "+s.classid+"/"+s.id +" "+type);
		}
		else if(s.type.equals("@int")){
			type ="I";
			this.isayln("putfield "+s.classid+"/"+s.id +" "+type);
