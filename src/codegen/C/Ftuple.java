...
public class Ftuple
{
  ...
  public java.util.LinkedList<codegen.C.dec.T> locals; // type of locals
  public String id; // name of the field or method

  public Ftuple(String classs, codegen.C.type.T ret,
      java.util.LinkedList<codegen.C.dec.T> args, 
      java.util.LinkedList<codegen.C.dec.T> locals,String id)
  {
    this.classs = classs;
    this.ret = ret;
    this.args = args;
