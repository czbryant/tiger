...
public class DeadCode implements ast.Visitor {
	...
	public void visit(ast.exp.And e) {
		...
		ast.exp.T RR = this.exp;
		if (this.can_cal) {
			R_bool = this.bool_res;
			this.bool_res = (L_bool && R_bool);
		}
		this.exp = new ast.exp.And(LL, RR, e.line);
	}
	...
	public void visit(ast.exp.Lt e) {
		...
		if (this.can_cal) {
			R_int = this.int_res;
			this.bool_res = (L_int < R_int);
		}
		this.exp = new ast.exp.Lt(LL, RR, e.line);
		return;
	}
